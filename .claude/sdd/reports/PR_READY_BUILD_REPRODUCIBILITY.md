# PR READY: BUILD_REPRODUCIBILITY
...
pr_ready:
  ...
  checks:
    ...
    must_requirements_covered:
      result: pass
      evidence: {source: artifact, reference: "BUILD_REPORT_BUILD_REPRODUCIBILITY.md#traceability-matrix"}
    branch_verdict:
      result: clean
    ...
    residual_risks:
      result: pass
      evidence: {source: artifact, reference: "BUILD_REPORT_BUILD_REPRODUCIBILITY.md#final-status"}
```
