# PR READY: SEMANTIC_RELEASE_EVIDENCE_GATE
...
pr_ready:
  ...
  checks:
    ...
    must_requirements_covered:
      result: pass
      evidence: {source: artifact, reference: "BUILD_REPORT_SEMANTIC_RELEASE_EVIDENCE_GATE.md#traceability-matrix"}
    branch_verdict:
      result: clean
    ...
    residual_risks:
      result: pass
      evidence: {source: artifact, reference: "BUILD_REPORT_SEMANTIC_RELEASE_EVIDENCE_GATE.md#final-status"}
```
