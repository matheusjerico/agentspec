# PR READY: FEATURE_BUNDLE_HANDOFF
...
pr_ready:
  ...
  checks:
    ...
    must_requirements_covered:
      result: pass
      evidence: {source: artifact, reference: "BUILD_REPORT_FEATURE_BUNDLE_HANDOFF.md#traceability-matrix"}
    branch_verdict:
      result: clean
    ...
    residual_risks:
      result: pass
      evidence: {source: artifact, reference: "BUILD_REPORT_FEATURE_BUNDLE_HANDOFF.md#final-status"}
```
