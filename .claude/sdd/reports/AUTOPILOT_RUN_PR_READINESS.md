# AUTOPILOT RUN: Pr Readiness

> Autonomous run record for PR_READINESS — the run's single source of state (resume replays the Gate Ledger) and its authoritative report. Created at OPEN, before Gate I can possibly fail; rows appended the moment each gate resolves.
...
| **Artifact Suffix** | PR_READINESS — immutable, derived from the DEFINE filename; DESIGN, BUILD_REPORT, and AUTOPILOT_RUN must all use this exact suffix |
| **Started** | 2026-07-29 20:15Z |
...
|-------|----------|-------------------|--------------|
| Ignition | .claude/sdd/features/DEFINE_PR_READINESS.md | pending | I: re-score 15/15 |
| Design | pending | - | - |
| Build | pending | - | - |
| Ship | pending | - | - |
| PR | pending | - | - |
...
|---|-------|----------------|-------|------------|-----------|
| 1 | interview | Phase 0 conduct | Ratified plan §14 as the Phase 0 artifact | 0.95 | Same basis as prior runs |
