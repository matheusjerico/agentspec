...
pr_ready:
  ...
  checks:
    ...
    must_requirements_covered:
      result: pass
      evidence: {source: artifact, reference: "BUILD_REPORT_TARGET_TIP_FRESHNESS.md#traceability-matrix"}
    branch_verdict:
      result: clean
    ...
    residual_risks:
      result: pass
      evidence: {source: artifact, reference: "BUILD_REPORT_TARGET_TIP_FRESHNESS.md#final-status"}
```
