...
| 5 | Important (F5) | DESIGN cited a phantom `build.report_contract.metrics` wiring key (4 places) | DESIGN doc | fixed in fix-round-2 (2 of 4 citations in round 1): all citations rewritten to the real top-level arming; repo-wide grep 0 hits |
