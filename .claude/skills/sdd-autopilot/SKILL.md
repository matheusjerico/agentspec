...
2. OPEN       Create .claude/sdd/reports/AUTOPILOT_RUN_{FEATURE}.md from
              .claude/sdd/templates/AUTOPILOT_RUN_TEMPLATE.md — Status: In Progress,
