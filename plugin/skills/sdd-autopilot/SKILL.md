...
2. OPEN       Create .claude/sdd/reports/AUTOPILOT_RUN_{FEATURE}.md from
              ${CLAUDE_PLUGIN_ROOT}/sdd/templates/AUTOPILOT_RUN_TEMPLATE.md — Status: In
...
- Sensor contracts: `${CLAUDE_PLUGIN_ROOT}/sdd/architecture/WORKFLOW_CONTRACTS.yaml` (`contract_enforcement`, `behavioral_enforcement`, `build.execution`, `ship.pre_ship_checklist`) · `${CLAUDE_PLUGIN_ROOT}/tools/spec-linter/USAGE.md` · `${CLAUDE_PLUGIN_ROOT}/tools/spec-judge/USAGE.md` · clarity rubric: `${CLAUDE_PLUGIN_ROOT}/skills/sdd-define/SKILL.md`
- Phase methodologies: `${CLAUDE_PLUGIN_ROOT}/skills/sdd-brainstorm|define|design|build|ship/SKILL.md` (Brainstorm/Define: pre-ignition, supervised)
